...
import {IAdapter, MaturityData} from "./IMidnightAdapter.sol";
...
interface IMidnightAdapterShortCircuitGasBenchmark is IAdapter, IBuyCallback, ISellCallback, IRatifier {
    /* EVENTS */
