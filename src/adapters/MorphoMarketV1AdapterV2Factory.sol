...
contract MorphoMarketV1AdapterV2Factory is IMorphoMarketV1AdapterV2Factory {
    ...
    mapping(address parentVault => mapping(address morpho => address)) public morphoMarketV1AdapterV2;
    ...
    constructor(address _adaptiveCurveIrm) {
        ...
        emit CreateMorphoMarketV1AdapterV2Factory(adaptiveCurveIrm);
    }
    ...
    function createMorphoMarketV1AdapterV2(address parentVault, address morpho) external returns (address) {
        ...
        morphoMarketV1AdapterV2[parentVault][morpho] = _morphoMarketV1AdapterV2;
        isMorphoMarketV1AdapterV2[_morphoMarketV1AdapterV2] = true;
        emit CreateMorphoMarketV1AdapterV2(parentVault, morpho, adaptiveCurveIrm, _morphoMarketV1AdapterV2);
