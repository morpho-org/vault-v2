...
contract IRM {
    ...
    // Note also that the formula for it is totally arbitrary at the moment, and it is only meant to show that the rate
    // is somewhat controlling totalAssets to target realAssets.
