...
Public callers must pay the vault's penalty on each `reallocate` or `allocateFromIdle` call, a proportion of the assets moved, paid in the market's loan token.
