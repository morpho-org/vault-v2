...
interface IVaultV2 is IERC20 {
    ...
    function allocation(bytes memory) external view returns (uint256);
    function lastUpdate() external view returns (uint256);
    function absoluteCap(bytes memory) external view returns (uint256);
    function relativeCap(bytes memory) external view returns (uint256);
    function idsWithRelativeCap(uint256) external view returns (bytes memory);
    function validAt(bytes memory) external view returns (uint256);
