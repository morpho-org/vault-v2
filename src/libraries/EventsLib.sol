...
library EventsLib {
    ...
    event RequestExit(address indexed sender, uint256 shares, address indexed supplier);
    event ClaimExit(address indexed sender, uint256 claimedShares, address indexed receiver, address indexed supplier);
