...
uint256 constant MAX_RATE_PER_SECOND = 200e16 / uint256(365 days); // 200% APR
...
// Capped to 50% of the assets after the loss.
uint256 constant LOSS_REALIZATION_INCENTIVE_RATIO = 0.01e18; // 1%
