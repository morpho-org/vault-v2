...
contract VaultV2 is IVaultV2 {
    ...
    function _withdraw(uint256 assets, uint256 assetsToTransfer, uint256 shares, address receiver, address onBehalf)
        internal
    {
    ...
    function withdraw(uint256 assets, address receiver, address onBehalf) public returns (uint256) {
        ...
        _withdraw(assets, assets, shares, receiver, onBehalf);
        return shares;
    }
