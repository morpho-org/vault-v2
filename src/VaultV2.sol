...
/// @dev Ids being reused are useful to do "cross-caps" (capping investments that have a common property). Adapters can
/// add "this" to an id to avoid it being reused.
