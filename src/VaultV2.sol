...
/// @dev Donations and forceDeallocate penalties increase the rate, which can attract and go to opportunistic
/// depositors. This fact can be mitigated by reducing the maxRate.
///
/// CAPS
