...
[Morpho Vault V2](https://github.com/morpho-org/vaults-v2/blob/main/src/VaultV2.sol) vaults are [**ERC-4626](https://eips.ethereum.org/EIPS/eip-4626)** vaults, **CHECK** with ([ERC-2612](https://eips.ethereum.org/EIPS/eip-2612)) permit.
