...
contract MorphoVaultV1_1IntegrationIkrTest is MorphoVaultV1_1IntegrationTest {
    ...
    function testRedeemSharesOfMorphoVaultV1_1(uint256 assets) public {
        ...
        assertEq(underlyingToken.balanceOf(address(this)), deallocatedAssets, "balanceOf(this)");
        ...
        assertEq(expectedAssets, deallocatedAssets, "expectedAssets");
    }

    function testRedeemSharesOfMorphoBlue(uint256 assets) public {
        assets = bound(assets, MIN_IKR_TEST_ASSETS, MAX_IKR_TEST_ASSETS);
        setUpAssets(assets);
