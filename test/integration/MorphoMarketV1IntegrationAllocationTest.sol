...
contract MorphoMarketV1IntegrationAllocationTest is MorphoMarketV1IntegrationTest {
    ...
    function setUp() public virtual override {
        ...
        assertEq(vault.caps(keccak256(expectedIdData1[2])).allocation, initialInMarket1);
        assertEq(vault.caps(keccak256(expectedIdData2[2])).allocation, 0);
    }
    ...
    function testDeallocateLessThanAllocated(uint256 assets) public {
        ...
        assertEq(vault.caps(keccak256(expectedIdData1[2])).allocation, initialInMarket1 - assets);
    }
    ...
    function testAllocateLessThanIdleToMarket2(uint256 assets) public {
        ...
        assertEq(vault.caps(keccak256(expectedIdData1[2])).allocation, initialInMarket1);
        assertEq(vault.caps(keccak256(expectedIdData2[2])).allocation, assets);
    }
