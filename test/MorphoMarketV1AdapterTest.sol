...
contract MorphoMarketV1AdapterTest is Test {
    ...
    function testDeallocate(uint256 initialAssets, uint256 withdrawAssets) public {
        ...
        vm.prank(address(parentVault));
        adapter.allocate(abi.encode(marketParams), initialAssets, bytes4(0), address(0));
        ...
        vm.prank(address(parentVault));
        (bytes32[] memory ids, uint256 interest) =
            adapter.deallocate(abi.encode(marketParams), withdrawAssets, bytes4(0), address(0));
    ...
    function testLossRealizationImpossible(uint256 deposit) public {
        ...
        vm.prank(address(parentVault));
        adapter.allocate(abi.encode(marketParams), deposit, bytes4(0), address(0));
    ...
    function testLossRealizationZero(uint256 deposit) public {
        ...
        // Realize loss.
        vm.prank(address(parentVault));
        (bytes32[] memory ids, uint256 loss) = adapter.realizeLoss(abi.encode(marketParams), bytes4(0), address(0));
    ...
    function testLossRealizationAfterAllocate(uint256 deposit1, uint256 _loss, uint256 deposit2) public {
        ...
        vm.prank(address(parentVault));
        adapter.allocate(abi.encode(marketParams), deposit1, bytes4(0), address(0));
        _overrideMarketTotalSupplyAssets(-int256(_loss));

        // Allocate.
        vm.prank(address(parentVault));
        adapter.allocate(abi.encode(marketParams), deposit2, bytes4(0), address(0));
    ...
    function testLossRealizationAfterDeallocate(uint256 initial, uint256 _loss, uint256 withdraw) public {
        ...
        vm.prank(address(parentVault));
        adapter.allocate(abi.encode(marketParams), initial, bytes4(0), address(0));
        _overrideMarketTotalSupplyAssets(-int256(_loss));

        // Deallocate.
        vm.prank(address(parentVault));
        adapter.deallocate(abi.encode(marketParams), withdraw, bytes4(0), address(0));
