...
methods {
    ...
    function _.expectedMarketBalances(Morpho.MarketParams marketParams) internal => summaryExpectedMarketBalances(marketParams) expect(uint256, uint256, uint256, uint256);
}
