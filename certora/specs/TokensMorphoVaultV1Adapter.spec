...
methods {
    ...
    function _.supply(MetaMorpho.MarketParams marketParams, uint256 assets, uint256 shares, address onBehalf, bytes data) external with(env e) => summarySupply(e, marketParams, assets, shares, onBehalf, data) expect(uint256, uint256) ALL;
    function _.withdraw(MetaMorpho.MarketParams marketParams, uint256 assets, uint256 shares, address onBehalf, address receiver) external with(env e) => summaryWithdraw(e, marketParams, assets, shares, onBehalf, receiver) expect(uint256, uint256) ALL;
    ...
    // Simplify setup, which is safe because they should not change tokens balances.
