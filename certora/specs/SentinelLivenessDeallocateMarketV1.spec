...
rule sentinelCanDeallocate(env e, address adapter, MorphoMarketV1Adapter.MarketParams marketParams, uint256 assets) {
    ...
    bytes data = Utils.encodeMarketParams(marketParams);
